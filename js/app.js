...
function downloadPDF() {
    if(selectedCourse.length == 0) {
        console.log("Please add at least one course!")
    }
    else {
        ...
        pdf.html(document.getElementById("pdfContainer"), {
            callback: function (pdf) {
                var base64 = pdf.output('blob');
                console.log(base64);
                var blobUrl = URL.createObjectURL(base64);
...
document.getElementById("disabledCourse").onclick = function () {
    console.log("Please select department first!")
}

document.getElementById("disabledSection").onclick = function () {
    console.log("Please select course first!")
}
document.getElementById("disabledButton").onclick = function () {
    console.log("Please select all inforamtion first!")
}